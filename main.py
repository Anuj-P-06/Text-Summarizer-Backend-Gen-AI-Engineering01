...
from tasks import run_task, tasks
...
def create_task(req: SummarizeRequest):
    ...
    return {"task_id": task_id, "status_url": f"/status/{task_id}", "result_url": f"/result/{task_id}"}
...
#for getting the result of long/complicated tasks
